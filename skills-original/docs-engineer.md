...
**README Structure**: Essential README for any project
**API Documentation**: Clear, complete API documentation
**Tutorial Structure**: Step-by-step tutorial that actually teaches

## Anti-Patterns to Avoid

- **Documenting the Obvious**: Adds noise without value. Gets out of sync with code.
- **Outdated Documentation**: Wrong docs are worse than no docs. Create false confidence.
- **Wall of Text**: Developers skim. Long text is skipped.
